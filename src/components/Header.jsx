  ...
  return (
    ...
    >
      <nav className={`flex items-center justify-between container mx-auto`}>
        ...
        <ul className={`lg:flex gap-5 sm:opacity-100 ${active ? " px-5 absolute top-[80px] right-0 left-0 w-full h-auto pb-4 opacity-90 sm:pb-0 bg-[#0F0D0E] duration-300" : "opacity-0 h-0"}`}>
          <li>
            <a
